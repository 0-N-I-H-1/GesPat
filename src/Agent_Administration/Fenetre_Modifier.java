...
public class Fenetre_Modifier {
    ...
    public Fenetre_Modifier(String nom, String prenom, String numeroSecuriteSociale, String dateNaissance, int ligneModelTablePatient) {
        ...
        labelInfo = new JLabel("<html><div align=center>*Le remplissage d'une seule catégorie minimum est nécessaire pour pouvoir valider. Remplir plus de catégorie est facultatif.</html>");
    ...
    private String stringInstanciationViaTextField() {
        ...
        Boolean P = !textFieldPrenom.getText().equals("Nouveau Prénom");
    ...
    /*Modifie les informations d'un patient de la base de données dans le fichier patient.txt ainsi que dans le fichier consultations.txt si nécessaire ;
    pour éviter de perdre toutes les données assignées à son ancienne identité dont ses potentiels ancienne consultations.*/
    private void modifierPatientTXT(String nouvelleLigne) {
        try {
            ...
            //Copie et colle chaque ligne du fichier patient dans un nouveau fichier temporaire et ajoute la nouvelle ligne de donnée a la place de l'ancienne.
        ...
        try {
            ...
            /*La boucle identifie et compare chaque catégorie de donnée pour trouver l'existence du patient dont on change l'identité.
            Si nous trouvons un patient possédant une identité exactement identique, on applique les changements demandés sinon on restaure la ligne sans modification.*/
