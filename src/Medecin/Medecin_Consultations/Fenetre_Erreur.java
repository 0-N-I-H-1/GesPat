...
public class Fenetre_Erreur extends Fenetre_Visualiser_Patient {

    private JFrame pageErreur;
    private JPanel panelPrincipal;
    private JButton boutonRetour, boutonAjouter, boutonAnnuler;
    private JLabel labelInfo;
    private int mouseX, mouseY;
    private ImageIcon logo;
    
    public Fenetre_Erreur(String nom, String prenom, String numeroSecuriteSociale, String dateNaissance) {
    ...
    private void fenetreErreur() {        
        ...
        boutonAjouter.setBounds(10,180,150,40);
        boutonAjouter.setBackground(new Color(215, 175, 112, 255));
        boutonAnnuler.setBounds(240,180,150,40);   
    ...
    private class BoutonAjouter implements ActionListener {
        public void actionPerformed(ActionEvent Event) {
